...
2. Send **SCRNSAVR.8xp** and **ScrnSav.0.8xv**, along with any animations (found in the **Animations** directory) of your choice to your calculator using TI-Connect CE or TiLP. If you don't have the [CE C libraries](https://tiny.cc/clibs), you'll need to download and send those as well.
