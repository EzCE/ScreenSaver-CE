...
void redraw(uint8_t option, bool hookEnabled, uint8_t animation, uint8_t apdTimer) {
    static const char *names[ANIMATION_COUNT] = {"Toasters", "Pipes", "Fish", "Walk", "Clock", "Tiles", "Spiral", "Matrix"}; // Add screensaver names here
    static const char *authors[ANIMATION_COUNT] = {"TIny, RoccoLox", "TIny, RoccoLox", "Merth", "Merth", "TIny, RoccoLox", "TIny, RoccoLox", "Merth", "Merth, v3x3d"}; // Add screensaver authors here
