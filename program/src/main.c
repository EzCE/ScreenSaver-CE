...
void redraw(bool option, bool hookEnabled, uint8_t animation) {
    static const char *names[ANIMATION_COUNT] = {"Hello", "Toasters", "Pipes"}; // Add screensaver names here
    static const char *authors[ANIMATION_COUNT] = {"TIny, RoccoLox", "TIny, RoccoLox", "TIny, RoccoLox"}; // Add screensaver authors here
